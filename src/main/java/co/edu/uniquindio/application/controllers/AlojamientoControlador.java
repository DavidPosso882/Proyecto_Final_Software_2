...
public class AlojamientoControlador {
    ...
    public ResponseEntity<RespuestaDTO<AlojamientoDTO>> crearAlojamiento(@Valid @RequestBody CreacionAlojamientoDTO dto) throws Exception {
        ...
        // Por ahora, devolvemos null ya que el método obtenerAlojamientoId no está implementado
        // En una implementación completa, aquí se debería mapear la entidad guardada a DTO
        AlojamientoDTO respuesta = null;
